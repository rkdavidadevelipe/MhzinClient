shared.LoaderTitle = "Carregando script LFERDA HUB";
...
local messages = {
    "Script LFERDA HUB",
    "LFERDA está dominando",
    "O melhor",
    "Vai ativar em breve; talvez seja necessário reiniciar"
}
...
game.StarterGui:SetCore("SendNotification", {
    Title = "MT3ATI HUB";
    Text = "Ativado com sucesso"; -- ARAB TEAM
    Duration = 5;
})
...
wait(0.5)
game.StarterGui:SetCore("SendNotification", {
    Title = "Obrigado por usar o script";
...
local Tab = Window:MakeTab({"Informações"})
...
local Tab = Window:MakeTab({"Servidor"})

Tab:AddButton({
    Name = "Servidor aleatório",
    Description = "اضغط لدخول Servidor aleatório",
    Callback = function()
...
Tab:AddButton({
    ...
    Description = "اضغط لReentrar no servidor",
    Callback = function()
...
Tab:AddButton({
    Name = "Sair do mapa",
    Description = "اضغط للSair do mapa",
    Callback = function()
        game:Shutdown()
    end
})
...
Tab:AddButton({
    Name = "Abrir o Console",
    Description = "اضغط هنا لAbrir o Console",
    Callback = function()
...
local Toggle1 = Tab:AddToggle({
  Name = "Notificações de entrada/saída dos jogadores",
  Description = "عندما تفعل هذه الاشعارات سيتم ارسال Notificações de entrada/saída dos jogadores",
  Default = false 
})
...
local Tab = Window:MakeTab({"Jogador"})
...
Tab:AddSlider({
    Name = "Aumentar FPS",
    Description = "Aumentar FPS اقصى حد",
    Min = 144,
    Max = 1000,
    Increase = 1,
    Default = 1000,
...
local Toggle3 = Tab:AddToggle({
    Name = "اضغط لتشغيل Aumentar FPS",
    Description = "تشغيل او ايقاف Aumentar FPS",
    Default = true,
...
local Toggle1 = Tab:AddToggle({
    Name = "Pulo infinito",
    Description = "اضغط لتشغيل Pulo infinito",
    Default = false,
    Callback = function(state)
...
Tab:AddButton({
    Name = "Remover efeitos gráficos 2",
    Description = "",
    Callback = function()
...
local Toggle1 = Tab:AddToggle({
    Name = "Mostrar FPS e Ping",
    Description = "اضغط لMostrar FPS e Ping",
    Default = false,
    Callback = function(state)
        if state then
...
Tab:AddButton({ 	Name  = "Reiniciar", 	Callback = function()
...
Tab:AddButton({ 	Name  = "Ferramenta de teleporte", 	Callback = function()

game.StarterGui:SetCore("SendNotification", {
    Title = "Stefan Hz";
    Text = "Ferramenta de teleporte recebida"; -- ARAB TEAM
    Duration = 5;
})
...
Tab:AddButton({ 	Name  = "Pegar sofá", 	Callback = function()
local args={[1]="PickingTools",[2]="Couch"};game:GetService("ReplicatedStorage").RE:FindFirstChild("1Too1l"):InvokeServer(unpack(args))
end })

Tab:AddButton({ 	Name  = "Explodir (troll)", 	Callback = function()
loadstring(game:HttpGet("https://pastefy.app/YZoglOyJ/raw"))()
end })

Tab:AddButton({ 	Name  = "Boombox (player de músicas)", 	Callback = function()
...
local Tab = Window:MakeTab({"Casa"})

Tab:AddButton({
    Name = "Remover bloqueio",
    Description = "اضغط هنا لRemover bloqueio",
    Callback = function()
...
Tab:AddButton({ 	Name  = "Abrir/Fechar garagem", 	Callback = function()
local args = {
						[1] = "GarageDoor"
					}
...
Tab:AddButton({ 	Name  = "Abrir/Fechar cortina", 	Callback = function()
local args = {
						[1] = "Curtains"
					}
					game:GetService("ReplicatedStorage"):WaitForChild("RE"):WaitForChild("1Player1sHous1e"):FireServer(unpack(args))
...
Tab:AddButton({ 	Name  = "حذف Casa", 	Callback = function()
local args = {
    [1] = "PlayerSellHouse"
}
...
Tab:AddButton({ 	Name  = "Trancar/Destrancar porta", 	Callback = function()
local args = {
    [1] = "LockDoors"
}
...
Tab:AddButton({ 	Name  = "Mudar cores da sua casa", 	Callback = function()
local colors = {
...
local Tab = Window:MakeTab({"Antis"})

local Toggle1 = Tab:AddToggle({
  Name = "Anti-sentar",
  Description = "اضغط الزر لتفعيل Anti-sentar",
  Default = false 
})
Toggle1:Callback(function(Value)
 local seats = {}
...
local Toggle1 = Tab:AddToggle({
  Name = "Anti-fling",
  Description = "اضغط لتفعيل Anti-fling",
  Default = false 
})
Toggle1:Callback(function(Value) 
...
local Toggle2 = Tab:AddToggle({
    Name = "Anti-idle",
    Description = "اضغط لتشغيل Anti-idle",
    Default = false,
    Callback = function(Value)
        if state then
...
local Tab = Window:MakeTab({"Troll"})
...
Tab:AddTextBox({
    Name = "اكتب اسم Jogador هنا",
    Default = "Digite o nome aqui",
    TextDisappear = false,
    Callback = function(Value)
...
Tab:AddToggle({
    Name = "Loop de teleporte automático para jogador",
    Callback = function(Value)
        loopTP = Value
        if loopTP then
            task.spawn(function()
...
Tab:AddToggle({
    Name = "سحب بالكنبه",
    Description = "اضغط لسحب Jogador بالكنبه",
    Default = false,
    Callback = function(state)
        bringActive = state
        if state and selectedPlayer then
...
local Section = Tab:AddSection({"تقفيل Servidor بيتا"})

Tab:AddButton({
  Name = "تقفيل Servidor اداه اطفاء الحريق قوي",
  Callback = function()
          local TextChatService = game:GetService("TextChatService")
        if TextChatService.ChatVersion == Enum.ChatVersion.TextChatService then
            local message = ".\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r⚠️تحذير سيتم قفل Servidor⚠️"
...
wait(5)
        ...
        local TextChatService = game:GetService("TextChatService")
        if TextChatService.ChatVersion == Enum.ChatVersion.TextChatService then
            local message = ".\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r✅️جار قفل Servidor✅️"
            TextChatService.TextChannels.RBXGeneral:SendAsync(message)
        else
    end
...
Tab:AddButton({
  Name = "توقيف تقفيل Servidor",
  Callback = function()
        local TextChatService = game:GetService("TextChatService")
        if TextChatService.ChatVersion == Enum.ChatVersion.TextChatService then
            local message = ".\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r✅️تم ايقاف قفل Servidor✅️"
            TextChatService.TextChannels.RBXGeneral:SendAsync(message)
        else
        end
...
local Tab = Window:MakeTab({"Scripts من صنعي"})
local Section = Tab:AddSection({
	Name = "جميع الScripts هنا من صنعي"
})
...
wait(1.2)
game.StarterGui:SetCore("SendNotification", {
Title = "Bem-vindos a todos"; -- the title (ofc)
...
local Tab = Window:MakeTab({"Scripts fortes"})
...
local Tab = Window:MakeTab({"Chat"})

-- SeÃ§Ã£o: Enviar uma mensagem normal
local playerInput1 = ""

Tab:AddSection({Name = "Mensagem normal"})
...
Tab:AddSection({Name = "Mensagem do servidor"})
...
Tab:AddSection({Name = "Mensagem do admin"})
...
Dropdown = Tab:AddDropdown({
    Name = "اختار Jogador الذي تريد الانتقال له و سيتم الانتقال تلقائيا",
...
local Tab = Window:MakeTab({"Configurações"})
...
local TextChatService = game:GetService("TextChatService")
        if TextChatService.ChatVersion == Enum.ChatVersion.TextChatService then
            local message = ".\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r✅️Ativado com sucesso LFERDA✅️"
            TextChatService.TextChannels.RBXGeneral:SendAsync(message)
        else
        end
