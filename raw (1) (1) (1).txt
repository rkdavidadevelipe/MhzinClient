...
local Paragraph = Tab1:AddParagraph({"Criadores", "the rk_davida"})
  ...
  Tab1:AddButton({
    ...
    Callback = function()
      setclipboard("@Rbzin_editz777") -- Copia o @
      setclipboard("https://www.tiktok.com/@rbzin_editz777?_t=ZM-90CusGVAVUi&_r=1") -- Copia o link também, se quiser só o @, remova esta linha
...
createMusicDropdown("Phonk", {
    ["phonk"] = {
        ...
        {name = "MONTAGEM RUGADA", id = "82052673545356"},
        {name = "", id = ""},
        {name = "", id = ""},
        {name = "", id = ""},
        {name = "", id = ""},
