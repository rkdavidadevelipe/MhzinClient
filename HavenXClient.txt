...
local Window = redzlib:MakeWindow({
    Title = "HavenXClient | Brookhaven RP 🌌🏡 2.1",
...
local Section = Tab1:AddSection({"versao do Hub 2.1"})

local Paragraph = Tab1:AddParagraph({"Criadores", "The Wolf"})
...
Tab12:AddButton({
    ...
    Callback = function()
        loadstring(game:HttpGet("https://raw.githubusercontent.com/rkdavidadevelipe/MhzinClient/refs/heads/main/HavenXClientADM.lua", true))()
    end
})
